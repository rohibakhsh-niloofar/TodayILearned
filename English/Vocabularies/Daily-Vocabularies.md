...
||Word|Definitions or Examples|
|--|--|--|
|1|Accounting|the process of keeping financial accounts|
|2|Assignment|a pieces of work that is given to sb as a task|
|3|Department|large organization such as hospital,university, ...|
|4|Forgotten|Irregular form of forget|
|5|Register|sb or sth name on an official list|
|6|Semester|one of the two periods of time that a year at university is divided into|
|7|Unusual|Odd, Different, Unconventional|
|8|Give (sb) a call|To phone sb|
|9|Let me see|Kind of hesitate to save time for thinking|
|10|Wit a minute|Hold on, Just a sec|

#### Unit-2 (Describing People)
||Word|Definitions and Examples|
|--|--|--|
|1|Actor|! Actress for women !|
|2|Almost|Nearly but not completely or quite|
|3|Shoulder length|Hair hangs down to your shoulders|
|4|Straight|In a line or direction that is not curved|
|5|Teens|Between 13 and 19 years old|
|6|Drive (sb) crazy|To make sb upset, make you mad|
|7|Look About|Use for estimate someone age|
...
|10|Have on|Put on, Wear `She has on a blue shirt`|


#### Unit-4 (Routines)
||Words|Definitions and Examples|
|--|--|--|
|1|Cereal|A breakfast food made from gain and usually eaten by milk|
|2|A morning person |Sb who wakes up early and more active in the mornings|
|3|A night person| Sb who stay up in late night and more active in the night|
|4|Fall asleep|To go to sleep, drop off|
|5|Get up|To get out of your bed after sleeping|
|6|Hang out|To spend a lot of time in a particular place or people|
|7|Depends on|It is directly affected or decided by that thing.`It depends on situation`|
|8|A quarter |It used for time, 15 min to/past a particular time|
